...
const BODY = {
	...
	battleship: "Battleships are powerful combat vessels which may equip one Weapon, one Shield, two Modules, and one Drone. With a 7k health pool, they can absorb significant damage.\n\nIn addition to player controlled Battleships, several computer controlled Rogue Battleships may jump into the arena at various points throughout the round. Rogue Battleships are identified by their pale salmon color, and destroying them will grant the player a small amount of health regeneration.",
